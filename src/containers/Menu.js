      ...
      <div>
        <Menu mode="horizontal">
          <Menu.Item key="transaction">
            <Icon type="mail" />Create Transaction
          </Menu.Item>
          <Menu.Item key="budget" >
            <Icon type="appstore" />Create Budget
          </Menu.Item>
        </Menu>
        ...
        <TransactionForm budgetCats={this.props.budgetCats} visible={this.state.trans_visible} onCreate={this.handleTransaOk} onCancel={this.handleTransCancel} ref={this.saveTransFormRef} />
      </div>
    );
  }
});
